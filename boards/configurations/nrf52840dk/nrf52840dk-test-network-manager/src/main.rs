...
type ThreadNetworkManagerDriver = components::thread_network_manager::ThreadNetworkManagerType<
...
pub struct Platform {
    ...
    dynamic_app_loader: &'static capsules_extra::app_loader::AppLoader<
        ...
        DynamicBinaryStorage<'static>,
    >,
    thread_network_manager: &'static ThreadNetworkManagerDriver,
}
...
impl SyscallDriverLookup for Platform {
        ...
        F: FnOnce(Option<&dyn kernel::syscall::SyscallDriver>) -> R,
    {
        match driver_num {
            ...
            capsules_extra::thread_network_manager::DRIVER_NUM => f(Some(self.thread_network_manager)),
            _ => f(None),
        }
    }
}
